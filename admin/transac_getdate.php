...
<body>
	<div class="overall">
		...
		<div class="container">
			<!--QUERY DATA-->
			<div style="center;margin-top:15px;">
					<?php  
							$datestart 	= date('Y-m-d', strtotime($_POST["date_start"]));
							$dateend 	= date('Y-m-d', strtotime($_POST["date_end"]));
							
							$sql = "SELECT * from transaction where tran_create between '$datestart' and '$dateend'";
					...
					<table border="1" style="width:100%">
						<tr style="background-color:lightblue;height:45px;">
							...
							<th style="width:17%"><a href="<?php echo $_SERVER["PHP_SELF"];?>?sort=tran_ems&order=<?php echo $strNewOrder?>">การจัดส่ง EMS</a></th>
						...
						<?php 
							$c = 0;
								while($result = mysql_fetch_array($qry))
								{
									...
									<td style="text-align:center"><a href="showtransac.php?show_id=<?php echo $result['tran_id']?>">ดูรายการ</a> | <a href="removetransac.php?remove_id=<?php echo $result['tran_id']?>" onClick="return confirm('ต้องการลบ');">ลบ</a></td></tr>
									<?php 
									}
									else
									{
